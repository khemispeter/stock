...
<div class="header">
 ...
 <div class="body">
      <div class="leftSidebar">
        ...
        <div class="menus">
          ...
          <div><a href="purchase.php">purchase</a> </div>
          <div><a href="vendor.php">vendor</a></div>
            <div><a href="sales.php">sale</a></div>
          <div><a href="customer.php">customer</a></div>
 ...
 <div class="vendor">
  <div class="positionting">
      ...
      <div class="right_top">customerDetails</div>
...
<div class="sidedform">
     ...
     <form class="butform">
      <div class="buttons">
        <button class="greens">Addcustomer</button>
